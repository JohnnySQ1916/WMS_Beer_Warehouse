...
class ProductService:
    ...
    def add_product_to_product_details(self, product_name: str, code: str, ean: str, unit_weight: Decimal, purchase_price: Decimal) -> None:
        with transaction(self.db):
            self.db.execute(text("""INSERT INTO product_details (product_name, code, ean, unit_weight, purchase_price)
    ...
    def product_exist_on_location(self, new_location: str, ean: str, location_choice: str, date: dt) -> bool:
    ...
    def insert_new_product(self, amount: int, new_location: str, ean: str, location_choice: str, date: dt) -> None:
        query = text("""
